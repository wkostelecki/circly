                   ...
                   ROI = 1)
{
  ...
  out_start = out_start * (1 - gap_width * length(out_start))
  out_end = out_end * (1 - gap_width * length(out_start))
  out_start = out_start + gap_width /2
  out_end = out_end + gap_width / 2
  out_start = (out_start + gap_width * 0:(length(out_start) - 1)) / 2 + 0.5
  out_end = (out_end + gap_width * 0:(length(out_start) - 1)) / 2 + 0.5
  
  in_start = in_start * (1 - gap_width * length(in_start))
  in_end = in_end * (1 - gap_width * length(in_start))
